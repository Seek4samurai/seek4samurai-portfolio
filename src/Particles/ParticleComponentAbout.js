...
const ParticleComponentAbout = (props) => {
  return (
    <Box>
        ...
        params={{
          ...
          interactivity: {
            ...
            modes: {
              ...
              connect: { distance: 80, links: { opacity: 0.5 }, radius: 80 },
              grab: {
                distance: 400,
          ...
          particles: {
            ...
            twinkle: {
              ...
              particles: { enable: true, frequency: 0.01, opacity: 0.3, duration: 2 }
            },
...
export default ParticleComponentAbout
